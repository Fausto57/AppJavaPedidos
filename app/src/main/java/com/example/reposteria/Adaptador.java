...
public class Adaptador extends RecyclerView.Adapter<Adaptador.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemview) {
            ...
            btnAcep.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        PostEstatusTermina(btnAcep.getText().toString());
        ...
        public void PostEstatusTermina(String ID) throws JSONException {
            System.out.println("se obtuvo entrar al post");
            String url = "https://royalback.herokuapp.com/api/UpdateTerminados/";
    ...
    public Adaptador(List<dataGetSet> lista, Context cont){
        this.Lista = lista;
        this.Cont = cont;
    }
